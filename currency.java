...
lblInputCurrency.setForeground(Color.ORANGE);
lblInputCurrency.setBackground(Color.ORANGE);
lblInputCurrency.setFont(new Font("Tahoma", Font.BOLD, 13));
...
lblOutputCurrency.setForeground(Color.ORANGE);
lblOutputCurrency.setBackground(Color.ORANGE);
lblOutputCurrency.setFont(new Font("Tahoma", Font.BOLD, 13));
lblOutputCurrency.setBounds(35, 154, 111, 14);
frame.getContentPane().add(lblOutputCurrency);

JLabel lblAmount = new JLabel("Amount");
lblAmount.setForeground(Color.ORANGE);
...
lblConvertedAmount.setForeground(Color.ORANGE);
lblConvertedAmount.setBackground(Color.ORANGE);
lblConvertedAmount.setFont(new Font("Tahoma", Font.BOLD, 13));
...
btnCovert.setForeground(Color.BLUE);
btnCovert.setBackground(Color.CYAN);
