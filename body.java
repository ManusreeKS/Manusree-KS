...
public class body {
	...
	private void initialize() {
		...
		lblNewLabel.setBounds(216, 219, 104, 19);
		...
		lblOutput.setBackground(Color.MAGENTA);
		...
		rdbtnCelcius_1.setBounds(295, 115, 121, 23);
		...
		rdbtnFahrenheit_1.setBounds(296, 153, 120, 23);
		...
		rdbtnKelvin_1.setBounds(296, 190, 120, 23);
